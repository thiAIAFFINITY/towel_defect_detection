...
class LabelConsistent:
    ...
    def _create_update_logs_file(self):
        ...
        with open(os.path.join(self.root_dir, LOG_FILE), 'w') as fp:
            for product_id in product_ids:
                fp.write(f"{os.path.join(self.root_dir, product_id)}\n")

        for product_id in product_ids:
            with open(os.path.join(self.root_dir, product_id, LOG_FILE), 'w') as fp:
    ...
    def is_create_new_product(self):
        product_logs = []
        with open(os.path.join(self.root_dir, LOG_FILE), "r") as fr:
    ...
    def is_modify_class(self) -> bool:
        ...
        for product_id in product_ids:
            ...
            with open(os.path.join(self.root_dir, product_id, LOG_FILE), 'r') as fp:
                for attr in fp:
